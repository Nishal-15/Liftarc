                ...
                <div className="row g-4 align-items-center">
                    <div className="col-lg-3 col-md-6 mb-4 mb-lg-0">
                        <a className="d-flex align-items-center gap-2 mb-4 text-decoration-none" href="#">
                            ...
                            <span className="navbar-brand-text fw-black text-light" style={{ fontFamily: '"Barlow Condensed", sans-serif', fontSize: '1.4rem', fontWeight: 900, letterSpacing: '0.1em', lineHeight: 1 }}>
                    ...
                    <div className="col-lg-3 col-md-6 mb-4 mb-lg-0 px-lg-5">
                        <h6 className="fw-black text-light text-uppercase mb-4" style={{ fontFamily: '"Barlow Condensed", sans-serif', fontSize: '1rem', letterSpacing: '0.1em' }}>Quick Links</h6>
                    ...
                    <div className="col-lg-3 col-md-6 mb-4 mb-lg-0">
                        <h6 className="fw-black text-light text-uppercase mb-4" style={{ fontFamily: '"Barlow Condensed", sans-serif', fontSize: '1rem', letterSpacing: '0.1em' }}>Core Expertise</h6>
                        <ul className="list-unstyled d-flex flex-column gap-3">
                    ...
                    <div className="col-lg-3 col-md-6">
                        <h6 className="fw-black text-light text-uppercase mb-4" style={{ fontFamily: '"Barlow Condensed", sans-serif', fontSize: '1rem', letterSpacing: '0.1em' }}>Connect With Us</h6>
